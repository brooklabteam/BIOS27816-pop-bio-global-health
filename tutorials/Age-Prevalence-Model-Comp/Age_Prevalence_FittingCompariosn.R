...
## Modified by Cara Brook, 2024
## Originally developed for E2M2: Ecological and Epidemiological Modeling in Madagascar
## by Cara Brook, 2020
## with code and data from Brook et al. 2017. Epidemics.

## This tutorial uses maximum likelihood techniques to fit models to data. Here,
...
## optimal model structure to fit each type of data. This is a more technical way
## of evaluating model fit than the Harare tutorial, in which you simply evaluate 
## how well the model recovers the data by eye.
