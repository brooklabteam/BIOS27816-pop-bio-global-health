...
time.out <- seq(0,365,.1)     # INCLUDE THE APPROPRIATE VALUE TO GET A SEQUENCE
...
## this is a model of an influenza epidemic in Paris. We'll label the plot
## accordingly. 
...
plot(ts.sir$time,               # Time on the x axis
     ...
     main = "Influenza in Paris",    # Plot title
     xlim = c(0,400),           #
